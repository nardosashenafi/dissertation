...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{image12.eps}
    \label{fig:training1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{image232.eps}
    \label{fig:training1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{image1398.eps}
    \label{fig:training1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{image4995.eps}
    \label{fig:training1}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{moetraj.eps}
    \caption{}
    \label{fig:cartpole_trajectory}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{moecontrol.eps}
    \caption{}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{cont.eps}
    \label{fig:continuous_control}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{contANDMOE.eps}
