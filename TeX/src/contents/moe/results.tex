...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.8\linewidth]{switching_results.eps}
    \subfloat[\label{final_switching_control}Control input]{\hspace{0.5\linewidth}} 
    \subfloat[\label{final_state_partition}State Partition]{\hspace{0.5\linewidth}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{switching_training.eps}
    \subfloat[\label{training_progress_control}Control input]{\hspace{0.5\linewidth}}
    \subfloat[\label{training_progress_partition}State partition]{\hspace{0.5\linewidth}}
...
\begin{figure}[tb]
    ...
    \begin{tikzpicture}
        ...
        \draw[-stealth, very thick,black]  (0.1,0.0) arc (90:140:1); 
        \node[] at (-0.3,0.3) {\small $\theta_p$};
        \draw[-stealth, very thick,black] (0.1,1.1) -- ++(-3.8, 0.0) node[above right,black]{\small $d=0.45$m};
        \draw[-stealth, very thick,black] (0.1,-1.2) -- ++(1.7, 0.0) node[above,black]{\small $x_c$};
    \end{tikzpicture}
    \caption{Cartpole with wall contacts}
    \label{fig:cartpole_contact}
\end{figure}
...
\begin{figure}[tb]
    ...
    \begin{tikzpicture}
        ...
        \draw[stealth-, ultra thick,red] (-4.2,2.2) -- ++(-2.0, 0.0) node[left,black]{\small Left wall};
        \draw[stealth-, ultra thick,red] (4.2,2.0) -- ++(1.3, 0.0) node[right,black]{\small Right wall};
