...
\rightarrow 6 neurons \rightarrow 4 neurons \rightarrow 1 output) and an \textsc{Elu} activation
...
Figure~\ref{fig:gapContour} shows the relationship between the gap function and the state partitions.
%
