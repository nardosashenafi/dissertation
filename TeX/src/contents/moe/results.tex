...
performance objective with $\mathcal{Q} = 3I_2, \mathcal{R} = 0I_2$, where $I_2$
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{switching_results.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{moe_traj_control.eps}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.6\linewidth]{cont.eps}
