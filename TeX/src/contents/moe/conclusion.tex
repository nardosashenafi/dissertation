...
event.~\todo{potential contact}

\todo[inline]{MoE does not necessarily change the controller due to potential
contact even though that may be the most intuitive \ldots}
