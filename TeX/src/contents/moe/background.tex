...
\begin{equation}
  \begin{gathered}
    ...
    \dd R = W_N^\top \dot{\lambda}_N \dd t + W_T^\top \dot{\lambda}_T \dd t
  \end{gathered}
...
\begin{figure}
  ...
  \begin{tikzpicture}
      ...
      \node[] at (4.8, 1.3) {\small $\mu \lambda_N$};
      \node[] at (3.7, -1.3) {\small $-\mu \lambda_N$};
...
\begin{figure}
  ...
  \begin{tikzpicture}
      ...
      \node[] at (4.3, 2.0) {\small $\lambda_L = \mu \lambda_N - \lambda_T$};
      \node[] at (7.6, 1.0) {\small $\lambda_R = \mu \lambda_N + \lambda_T$};
