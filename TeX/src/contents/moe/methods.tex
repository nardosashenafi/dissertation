...
\begin{enumerate}
    ...
    Section~\ref{ssec:mixture_of_experts}, the likelihood is maximum when the running cost 
    incurred by expert $i$ is low and the responsibility of the expert is high.
    %
...
\subsection{Back-propagation through Hybrid Systems}
