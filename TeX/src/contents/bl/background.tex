...
%
The system~\eqref{eq:hamiltonian_dynamics} has a stable equilibrium at the origin, i.e. 
\begin{align*}
  y \equiv 0 \Rightarrow x \equiv 0,
\end{align*}
if it holds the following passivity properties
\begin{equation*}
  \begin{gathered}
