...
\begin{figure}[H]
    ...
    \caption{Top: Torso orientation and velocity for 10-second-long trajectory. The
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\columnwidth]{RW_deterministic_control2.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{simulationComparison.eps}
