%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Modified from answer of
% https://tex.stackexchange.com/questions/503590/
...
\newcommand\nn[1]{
    % Input layer
    \foreach \y / \l in {1/2,2/1}
        \node[neuron, fill=green!40] (i\y-#1) at (0,\y+1) {$x_{\l}$};

    % Hidden layer
    \foreach \y / \l in {1/4,2/3,3/2,4/1}
        \path node[neuron, fill=blue!40] (h\y-#1) at (\layersep,\y) {$h_{\l}$};
