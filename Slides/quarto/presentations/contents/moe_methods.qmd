...
* Two major modifications to the *old faithful* example
    + training dataset is generated from trajectories
    + prediction error is replaced by running cost $\ell$ of the trajectories
:::
