...
## Mixture of Experts (MOE): Old Faithful {.smaller auto-animate="true"}
...
![](contents/assets/old_faithful.svg){.absolute top=100 left=600 width="550" height="400" .fragment .fade-in fragment-index=0}
